import pygame,sys
from src.data.save import *

class Menu_Marchand:
    def __init__(self):
        self.screen = pygame.display.get_surface()
        self.save_data = SaveData('src/data/save.json')
    ...
    def run(self):
        ...
        while True:
            ...
            font_grand = pygame.font.Font('src/assets/font/Enchanted_Land.otf', 50)
            ...
            image = pygame.image.load("src/assets/potions/potion_heal.png")
